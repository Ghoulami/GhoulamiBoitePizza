...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('formule') }}'><i class='nav-icon fa fa-heart'></i> Formules</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('client') }}'><i class='nav-icon fa fa-user'></i> Clients</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('commentaire') }}'><i class='nav-icon fa fa-commenting'></i> Commentaires</a></li>
...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('commandes') }}'><i class='nav-icon fa fa-question'></i> Commandes</a></li>