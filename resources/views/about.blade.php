...
<div class="container-wrapper">
    ...
    <div id="container">
        ...
        <div class="page-wrapper">
            ...
            <p><img class="aligncenter size-full wp-image-63" src="albertos/upload/vegies.jpg" alt="" width="415" height="366" /></p>
            <h1>Our team</h1>
            ...
            <p>&nbsp;</p>
            <p><img class="aligncenter size-full wp-image-65" src="albertos/upload/team.jpg" alt="" width="431" height="532" /></p>
            <div class="clear"></div>
        </div>
        <!-- end page wrapper -->
    </div>
